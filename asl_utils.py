...
def show_errors_2(guesses: list, test_set: SinglesData):
    """ Print WER and sentence differences in tabular form
...
def combine_sequences(split_index_list, sequences):
    '''
    concatenate sequences referenced in an index list and returns
    tuple of the new X,lengths
    useful when recombining sequences split using
    KFold for hmmlearn
